...
import React__default, { Fragment, Component, PureComponent, createElement, createRef, useState, useEffect } from 'react';
...
var PaymentMethodCardContentRead = function PaymentMethodCardContentRead(_ref) {
  var paymentMethod = _ref.paymentMethod,
      texts = _ref.texts;
  return React__default.createElement(Fragment, null, (paymentMethod.type === paymentMethodType.card || paymentMethod.type === paymentMethodType.total) && React__default.createElement("img", {
...
var s$M = {"deepBlue":"#163457","yellow":"#ffcd02","grey":"#4b4b50","blue":"#32a0c5","melrose":"#9ca3ff","green":"#59c871","white":"#fefefe","metalGrey":"#d5d6d7","lightMetalGrey":"#dededf","aquaHazeGrey":"#9eb3c2","darkGrey":"#a9b3c5","lightGrey":"#eceff6","red":"#ff5757","orange":"#f39c12","select":"Select-module_select__3oApo","disabled":"Select-module_disabled__1fHPm"};
styleInject(css$M);
...
var css$1f = ".IconButton-module_button__ZTBlf {\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  color: #163457;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n  padding: 15px;\n  width: 100%;\n}\n\n.IconButton-module_label__K6mXP {\n  margin-left: 10px;\n}\n";
var s$1d = {"deepBlue":"#163457","yellow":"#ffcd02","grey":"#4b4b50","blue":"#32a0c5","melrose":"#9ca3ff","green":"#59c871","white":"#fefefe","metalGrey":"#d5d6d7","lightMetalGrey":"#dededf","aquaHazeGrey":"#9eb3c2","darkGrey":"#a9b3c5","lightGrey":"#eceff6","red":"#ff5757","orange":"#f39c12","button":"IconButton-module_button__ZTBlf","label":"IconButton-module_label__K6mXP"};
styleInject(css$1f);

var css$1g = ".Box-module_box__2wWmS {\n  border-radius: 8px;\n  -webkit-box-shadow: 0px 2px 16px rgba(0, 0, 0, .12);\n          box-shadow: 0px 2px 16px rgba(0, 0, 0, .12);\n}\n";
var s$1e = {"deepBlue":"#163457","yellow":"#ffcd02","grey":"#4b4b50","blue":"#32a0c5","melrose":"#9ca3ff","green":"#59c871","white":"#fefefe","metalGrey":"#d5d6d7","lightMetalGrey":"#dededf","aquaHazeGrey":"#9eb3c2","darkGrey":"#a9b3c5","lightGrey":"#eceff6","red":"#ff5757","orange":"#f39c12","box":"Box-module_box__2wWmS"};
styleInject(css$1g);
...
var LanguageSelector = function LanguageSelector(_ref) {
  ...
  var _useState = useState(value ? getSelectValueFromLocale(value) : undefined),
