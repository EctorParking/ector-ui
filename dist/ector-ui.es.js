...
function (_React$Component) {
  ...
  _createClass(FlightInformationForm, [{
    key: "componentDidUpdate",
    value: function componentDidUpdate(prevProps) {
      var shouldDisplayReturnFlightInformation = this.props.shouldDisplayReturnFlightInformation;
      var oldShouldDisplayReturnFlightInformation = prevProps.shouldDisplayReturnFlightInformation;

      if (oldShouldDisplayReturnFlightInformation !== shouldDisplayReturnFlightInformation && shouldDisplayReturnFlightInformation) {
        this.setState({
...
var s$17 = {"select":"InputSelect-module_select__1hsvG","defaultClassName":"InputSelect-module_defaultClassName__1OTDJ"};
styleInject(css$18);
