...
var InputButton = function InputButton(_ref) {
  var id = _ref.id,
      ...
      LeftComponent = _ref.LeftComponent,
      inputProps = _objectWithoutProperties(_ref, ["id", "placeholder", "buttonText", "inputClassName", "inputContainerClassName", "inputButtonContainerClassName", "inputType", "hasError", "buttonVisible", "IconComponent", "ButtonComponent", "SubTextComponent", "LeftComponent"]);
...
var DefaultRightComponent = function DefaultRightComponent(_ref) {
  ...
  var renderHelpButton = function renderHelpButton(_ref2) {
    ...
    return React__default.createElement(TextIcon, {
      ...
      position: "right",
      backgroundClassName: s$19.backgroundTextIcon
    }, texts.needHelp);
  };
  ...
  return React__default.createElement("div", {
    ...
    buttonClassName: [s$19.menuItem, disabledButtons ? s$19.menuItemNotHovered : s$19.menuItemHovered].join(' '),
  ...
  _createClass(ScrollArrow, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("div", {
        role: "presentation",
        style: style,
        className: [s$1c.container, visible ? s$1c.visible : s$1c.hidden, className].join(' '),
