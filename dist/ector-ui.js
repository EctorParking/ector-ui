...
DateTimePicker.propTypes = {
  ...
  className: PropTypes$1.string,
  texts: TextsType$7,
  startDate: PropTypes$1.instanceOf(moment),
  endDate: PropTypes$1.instanceOf(moment),
  ...
  _createClass(FlightInformationForm, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(RootComponent, actualCardProps, fromSpotsAvailable.length > 1 && React__default.createElement("div", {
        ...
        className: [s$16.row, toSpotsAvailable.length <= 1 || !toSpot ? s$16.halfWidth : undefined, fromSpotsAvailable.length <= 1 ? s$16.noMargin : undefined].join(' ')
