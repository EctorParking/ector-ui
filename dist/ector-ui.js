...
function (_React$Component) {
  ...
  _createClass(FlightInformationForm, [{
    ...
    value: function render() {
      ...
      }, React__default.createElement("span", null, toSpot.type === 'airport' ? texts.switchMandatoryAirportDescription : texts.switchMandatoryStationDescription)), toSpot && toSpotsAvailable.length > 1 && React__default.createElement("div", {
