...
import bookingModificationSummaryTextType, {
  defaultTexts,
} from './BookingModificationSummaryTextsType';
...
const BookingModificationSummary = ({
  texts,
  className,
...
BookingModificationSummary.propTypes = {
  ...
  bookingModificationSummaryPrice:
    BookingModificationSummaryPriceType.isRequired,
};
